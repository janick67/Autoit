...
_FFSTart("http://salusek.republika.pl/stronka.html",0,2)
$html = _FFReadhtml("html")

StringReplace($html,"Prosta","cze")
;MsgBox(0,"",$html)
_FFWriteHTML($html,"html")

;_FFImageClick("/assets/img/gg_ico.png","src")
Exit
