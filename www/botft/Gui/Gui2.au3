...
Case $GUI_EVENT_CLOSE
	Exit
Case $Gpost[100][4]
	hpost(GUICtrlRead($Gpost[100][3]))	
	vpost(GUICtrlRead($Gpost[100][3])+1)
EndSwitch
WEnd
...
func vpost($strona)
	...
	$Gpost[100][1] = GUICtrlCreateButton("Usuñ",10,155,40,20)
	$Gpost[100][2] = GUICtrlCreateButton("<-Poprzednia",130,155,70,20)
	$Gpost[100][3] = GUICtrlCreateLabel($strona,211,159,50,17)
	$Gpost[100][4] = GUICtrlCreateButton("Nastêpna->",230,155,70,20)
	for $i = $i to $ile
		if $i <= $post[0][0] Then
	$Gpost[$i][0] = GUICtrlCreateCheckbox("",10,$t,15,15)
	$Gpost[$i][1] = GUICtrlCreateLabel($i,45,$t,100,15)
	$Gpost[$i][2] = GUICtrlCreateLabel("Informacja",185,$t,100,15)
	$Gpost[$i][3] = GUICtrlCreateLabel("Raport z treningu",305,$t,100,15)
	$t+=18
	EndIf
	Next
EndFunc
