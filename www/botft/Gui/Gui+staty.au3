...
func tgs()
	...
	if $i = 11 Then
		...
		$l = 145
	ElseIf $i = 18 Then
	$Ginfo[28][0] = GUICtrlCreateLabel(28,$l,$t,$w,$h)
	$Ginfo[28][1] = GUICtrlCreateLabel("ValorianLegends",$l+45,$t,$w,$h)
		$t = 23
		$l = 290
	EndIf
	$Ginfo[$i][0] = GUICtrlCreateLabel($i,$l,$t,$w,$h)
	$Ginfo[$i][1] = GUICtrlCreateLabel("ValorianLegends",$l+45,$t,$w,$h)
	$t+=14
	Next
	EndFunc
