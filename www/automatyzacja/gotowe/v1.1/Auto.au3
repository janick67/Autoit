...
FileInstall("kodowanie.ini","kodowanie.ini")
config()
...
While 1
	...
	Case $GUI_EVENT_CLOSE
		...
		Case $Gdialog ;przycisk przegl¹daj
			...
			dia($dia) ;funkcja otwieraj¹ca okno dialogowe i ustawiaj¹ca wartoœci inputom
...
Func dia($dia) ;funkcja ustawia inputy treœciami pobranymi z pliku og³oszeñ
